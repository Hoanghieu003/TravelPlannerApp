...
public class LineLogin extends ReactContextBaseJavaModule {
    ...
    private WritableMap parseLoginResult(LineLoginResult loginResult) {
        ...
        result.putString("idToken", loginResult.getLineIdToken().getRawString());
        return result;
    }
    ...
    private WritableMap parseAccessToken(LineAccessToken accessToken) {
      return parseAccessToken(accessToken, accessToken.getTokenString());
    }

    private WritableMap parseAccessToken(LineAccessToken accessToken, String idTokenRawString) {
        WritableMap result = Arguments.createMap();
        result.putString("accessToken", idTokenRawString);
